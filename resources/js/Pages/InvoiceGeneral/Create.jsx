...
const Create = ({ usersProp, partnersProp, salesProp, productsProp }) => {
    ...
    const {
        ...
        uuid: "",
        code: `${new Date().getTime()}/CAZH-INVOICE-GENERAL/X/${new Date().getFullYear()}`,
        products: [],
        total: 0,
        total_ppn: 0,
        total_all_ppn: 0,
    ...
    const handleInputChange = (index, field, value) => {
        ...
        if (field == "price" || field == "qty" || field == "ppn") {
            let totalUpdated =
        ...
        <>
            ...
            <div className="h-screen max-h-screen overflow-y-hidden">
                <div className="flex flex-col h-screen max-h-screen overflow-hidden md:flex-row z-40 relative gap-5">
                    ...
                    <div className="md:w-[60%] text-sm h-screen max-h-screen overflow-y-auto p-5">
                        <header>
                        ...
                        <div className="w-full mt-5">
                            <table className="w-full border">
                                <thead className="bg-purple-800 text-white text-center border">
                                    ...
                                    <th className="p-1 border">Total Harga</th>
                                    <th className="p-1 border">PPN</th>
                                </thead>
                                <tbody>
