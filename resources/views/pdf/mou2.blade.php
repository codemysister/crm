...
<body style="font-size: 13px">
    ...
    <div>
        ...
        <hr style="height: 1px; margin: 1.5rem 0; background-color: #718096; border: none;" />

        <div style="text-align: center; line-height: 1.5;">
            <h1 style="font-weight: bold; text-decoration: underline; margin: 0 auto;">
                BERITA ACARA KEMITRAAN
            </h1>
            <p style="font-weight: bold;">Nomor : </p>
        </div>
                    ...
                    <tr style="">
                        ...
                        <td style="">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td style="width: 20%;">Lokasi</td>
                                    <td>: <b>Kab. Bogor, Jawa Barat</b></td>
                                </tr>
                                <tr>
                                    <td colspan="2">Selanjutnya disebut sebagai “Pihak Pertama”.</td>
                                </tr>
                                        ...
                                        <tbody style="text-align: justify;">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    dengan alamat URL {"{URL Sub Domain}"} menggunakan peramban web (web
                                                    ...
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="border: 1px solid #d1d5db; padding: 5px">
                                                                    {Harga Langganan} per-{Langganan Per-}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
